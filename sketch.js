...
function preload(){
   ...
   bgImg = loadImage("Images/background.jfif");
...
function setup() {
  ...
  balloon=createSprite(800,650,150,350);
  balloon.addAnimation("hotAirBalloon",balloonImage1);
  balloon.scale=1;

  border=createSprite(1000,-1,2000,1);
  border2=createSprite(1000,1001,2000,1);
...
function draw() {
  ...
  balloon.collide(border);
balloon.collide(border2);
